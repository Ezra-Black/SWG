...
//  SWGalaxy App
//
//  Created by Ezra Black on 8/18/20.
...
final class PersonCollectionViewController: UICollectionViewController {
    ...
    //MARK: Outlets
    @IBOutlet weak var collectionViewPersonSearchBar: UISearchBar!
    ...
    override func viewDidLoad() {
        ...
        collectionViewPersonSearchBar.delegate = self
...
extension PersonCollectionViewController: UISearchBarDelegate {
    internal func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        self.collectionViewPersonSearchBar.endEditing(true)
